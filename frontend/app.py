...
if 'mqtt_client' not in st.session_state:
    ...
    try:
        ...
        client.loop_start() # Keeps connection alive in background
...
def load_and_prep_data():
    ...
    if os.path.exists(p_path) and os.path.exists(s_path):
        ...
        # Ensure 'Generation (kW)' exists in solar file
...
if df is not None:
    ...
    # --- BROADCAST ALL STATUS TO HIVEMQ ---
    ...
    if 'mqtt_client' in st.session_state:
        for app in app_list:
            ...
            # Send message through persistent client
        ...
        st.warning("MQTT Client not connected. Check credentials.")
